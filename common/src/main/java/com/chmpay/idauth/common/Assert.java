package com.chmpay.idauth.common;
...
public class Assert {
    ...
    public static void doesNotContain(String textToSearch, String substring, String message) {
        if(isEmpty(textToSearch) && isEmpty(substring) && textToSearch.contains(substring)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void isInstanceOf(Class<?> type, Object obj, String message) {
        ...
        if(!type.isInstance(obj)) {
            throw new IllegalArgumentException((!isEmpty(message)?message + " ":"") + "Object of class [" + (obj != null?obj.getClass().getName():"null") + "] must be an instance of " + type);
        }
    }
